...
if ($errorNum == 0) {
    if ($eventNum == 0) {
        $success = execute("INSERT INTO tb_size (size_name, qti_boxes_size, deleted_size) VALUES ($size_name, $qtiBoxSize, 0)");
        ...
        $success = execute("UPDATE tb_size SET size_name = $size_name, qti_boxes_size = $qtiBoxSize WHERE size_id = $id");
