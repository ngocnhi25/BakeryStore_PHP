<div class="overlay">
  ...
  <div class="page-wrapper">
          ...
          <div class="header-nav-inner-container">
            ...
            <div class="desktop-menu d-none d-lg-flex">
              <ul class="main-menu">
                ...
                <li class="li-menu">
                  <a href="tin-tuc.php/banh-giang-sinh-banh-noel-2022-giang-sinh-ngot-ngao-9.php">
                    B&aacute;nh Noel (HOT)
                  </a>
                </li>
                <li class="li-menu">
    ...
    <div class="owl-carousel main-carousel">
      <div>
        <a href="">
          <img src="source/Slideshow/Banh sinh nhat THB1.png" alt="">
        </a>
      </div>
      <div>
        <a href="">
          <img src="source/Slideshow/valentine banner.png" alt="">
        </a>
      </div>
    </div>
